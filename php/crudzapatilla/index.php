            ...
            <div class="card">
                <form action="save.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="titulo6" class="form-control" placeholder="Tarea" autofocus>
                    </div>
                    <div class="form-group">
                        <textarea type="textarea" name="descripcion6" class="form-control" placeholder="Descripcion de la Tarea"></textarea>
                    </div>
                    <div class="form-group">
                    <input type="file" name="images6" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="number" name="precio6" class="form-control" step="0.01" placeholder="Ingrese el precio" autofocus>
                    </div>
            ...
            <table class="tabla">
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_array($result_tareas)){ ?>
                        <tr>
                            <td><?php echo $row['titulo6'] ?></td>
                            <td><?php echo $row['descripcion6'] ?></td>
                            <td><?php echo $row['images6'] ?></td>
                            <td><?php echo $row['precio6'] ?></td>
                            <td><?php echo $row['fecha_registro6'] ?></td>
                            <td>
                                <a href="edit.php?id=<?php echo $row['idTarea6']?>" class="btn1">
                                    <i class="fas fa-marker"></i>
                                </a>
                                <a href="delete.php?id=<?php echo $row['idTarea6']?>&status=deleted" class="btn2">
