            ...
            <div class="card">
                <form action="save.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="titulo3" class="form-control" placeholder="Tarea" autofocus>
                    </div>
                    <div class="form-group">
                        <textarea type="textarea" name="descripcion3" class="form-control" placeholder="Descripcion de la Tarea"></textarea>
                    </div>
                    <div class="form-group">
                    <input type="file" name="images3" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="number" name="precio3" class="form-control" step="0.01" placeholder="Ingrese el precio" autofocus>
                    </div>
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_array($result_tareas)){ ?>
                        <tr>
                            ...
                            <td><?php echo $row['images3'] ?></td>
                            <td><?php echo $row['precio3'] ?></td>
                            <td><?php echo $row['fecha_registro3'] ?></td>
                            <td>
                                <a href="edit.php?id=<?php echo $row['idTarea3']?>" class="btn1">
                                    <i class="fas fa-marker"></i>
                                </a>
                                <a href="delete.php?id=<?php echo $row['idTarea3']?>&status=deleted" class="btn2">
