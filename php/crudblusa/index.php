            ...
            <div class="card">
                <form action="save.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="titulo2" class="form-control" placeholder="Tarea" autofocus>
                    </div>
                    <div class="form-group">
                        <textarea type="textarea" name="descripcion2" class="form-control" placeholder="Descripcion de la Tarea"></textarea>
                    </div>
                    <div class="form-group">
                    <input type="file" name="images2" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="number" name="precio2" class="form-control" step="0.01" placeholder="Ingrese el precio" autofocus>
                    </div>
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_array($result_tareas)){ ?>
                        <tr>
                            ...
                            <td><?php echo $row['images2'] ?></td>
                            <td><?php echo $row['precio2'] ?></td>
                            <td><?php echo $row['fecha_registro2'] ?></td>
                            <td>
                                <a href="edit.php?id=<?php echo $row['idTarea2']?>" class="btn1">
                                    <i class="fas fa-marker"></i>
                                </a>
                                <a href="delete.php?id=<?php echo $row['idTarea2']?>&status=deleted" class="btn2">
